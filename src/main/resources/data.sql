...
-- User Data
INSERT INTO `T_USER` (username, password, email, activated, date_created, bio, roles) VALUES ('admin', '$2a$10$HiaJpKERbSfcZcuG5vcvlOZDG6Y/5SkDKi9RvKsSK3t3Spl9.7u6u', 'admin@admin.com', 1, '2017-11-02', 'This is the bio, and I am cool, right?', 'ADMIN,USER');
INSERT INTO `T_USER` (username, password, email, activated, date_created, bio, roles) VALUES ('kevinkevin', '$2a$10$JpNhoN6KUsR/eRfr/E2CpuLhp8btgbMN9JXzblB2pLUUkIt8pQgtO', 'kevinkevin@kevin.com', 1, '2017-11-02', 'Kevin is handsome.', 'USER');

-- Category Data
INSERT INTO `T_CATEGORY` (name, weight, display_name, username, date_created) VALUES ('java', 1, 'Java', 'admin', '2017-11-02');
INSERT INTO `T_CATEGORY` (name, weight, display_name, username, date_created) VALUES ('python', 2, 'Python', 'kevinkevin', '2017-11-02');
INSERT INTO `T_CATEGORY` (name, weight, display_name, username, date_created) VALUES ('job-hunting', 3, '求职', 'kevinkevin', '2017-11-02');
